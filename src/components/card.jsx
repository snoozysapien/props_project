  ...
  <div class="mx-auto max-w-5xl px-5 py-24">
    <div class="mx-auto flex flex-wrap items-center lg:w-4/5">
      ...
      <div class="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
        ...
        <h1 class="my-4 text-3xl font-semibold text-black">{username}</h1>
        ...
        <div class="mb-5 mt-6 flex items-center border-b-2 border-gray-100 pb-5">
          <div class="flex items-center">
            ...
            <button class="h-6 w-6 rounded-full border-2 border-gray-300 focus:outline-none">{btnText}</button>
            <button class="ml-1 h-6 w-6 rounded-full border-2 border-gray-300 bg-gray-700 focus:outline-none">{btnText}</button>
            <button class="ml-1 h-6 w-6 rounded-full border-2 border-gray-300 bg-green-200 focus:outline-none">{btnText}</button>
          </div>
